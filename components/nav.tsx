  ...
  return (
    <>
      ...
      <div
        ...
        } bg-surface-mixed-200 fixed z-10 flex h-full flex-col justify-between border-r border-stone-200 p-4 transition-all dark:border-stone-700 dark:bg-dark-brown sm:w-60 sm:translate-x-0`}
      >
